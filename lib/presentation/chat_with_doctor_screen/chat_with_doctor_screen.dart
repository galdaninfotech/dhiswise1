...
import 'package:galdan_s_application2/widgets/app_bar/appbar_subtitle_three.dart';
...
class ChatWithDoctorScreen extends StatelessWidget {
  ...
  /// to push the named route for the videoCallScreen.
  ...
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the [NavigatorService]
  /// to push the named route for the audioCallScreen.
